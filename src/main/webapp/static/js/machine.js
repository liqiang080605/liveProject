$(function () {
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function ( data, type, full, meta ) {
            		...
            		if(null != extInfo) {
            			msgStr += '<input type="hidden" id="detail_agent_idc_'+ full.id +'" value="' + full.idc + '"  />'
    ...
    $('#table tbody').on( 'click', '.detail_a', function () {
        ...
        $('#detail_ip').text(ip);
        $('#detail_agent_idc').text($(this).parents("tr").find("#detail_agent_idc_" + id).val());
    ...
    $("div.toolbar")
        ...
        .append('<div class="btn-group margin"><button type="button" class="btn btn-flat bg-blue" name="delete">删除</button><button type="button" class="btn btn-flat bg-blue dropdown-toggle" style="height: 34px" data-toggle="dropdown" aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Toggle Dropdown</span> </button> <ul class="dropdown-menu" role="menu"><li><a name="batch_delete_resource">批量删除</a></li></ul> </div>')
    	...
    	.append('<button class="btn btn-flat bg-blue margin" id="sync">同步</button>')
        ;
    ...
    $('#batch').click(function(){
        ...
        var create_tmpl = [
            ...
            '<div class="form-group"><label class="col-sm-2 control-label">导入模板</label><div class="col-sm-10"><a href="/static/template.xls">template.xls</a></div></div>',
    ...
    $("[name='batch_delete_resource']").click(function(){
        var create_tmpl = [
    ...
    $("[name='batch_monitor_toggle']").click(function(){
        ...
        $modal.on("click",".btn.btn-primary",function(){
            ...
            if(validate_create_form($form)){
                ...
                $.jd_ajax({
                    url:"/machine/batch_monitor_toggle",
                    type:"post",
                    data:$form.serialize(),
                    ok:function(){
                        $modal.data("modal").close();
